...
signtool sign /debug /t http://timestamp.comodoca.com /f "C:\Users\hero\frontman_ci/build_msi/cloudradar.io.p12" /p %cert_pass% dist/frontman_32.msi
signtool sign /debug /t http://timestamp.comodoca.com /f "C:\Users\hero\frontman_ci/build_msi/cloudradar.io.p12" /p %cert_pass% dist/frontman_64.msi
